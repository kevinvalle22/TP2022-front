...
class ThoughstCreate extends StatefulWidget {
  final String idSend;

  ThoughstCreate(this.idSend);

  @override
  State<ThoughstCreate> createState() => _ThoughstCreateState();
}

class _ThoughstCreateState extends State<ThoughstCreate> {
                          ...
                          child: Center(
                            child: Container(
                              ...
                              child: RaisedButton(
                                ...
                                child: Text("REGISTRAR PENSAMIENTO",
                                    style: TextStyle(
                                        fontSize: 15.5,
                                        color:
