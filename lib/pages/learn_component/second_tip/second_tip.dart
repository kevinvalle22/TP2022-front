...
class MentalHealthPages extends StatefulWidget {
  final String idSend;
  MentalHealthPages(this.idSend);
  @override
  State<MentalHealthPages> createState() => _MentalHealthPagesState();
}

class _MentalHealthPagesState extends State<MentalHealthPages> {
  late Timer _timer;
  @override
  void initState() {
    _progress1 == 0;
        ...
        (timer) => setState(() {
              if (_progress1 == 1) {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => MentalHelpPage2(widget.idSend)));
              } else {
                _progress1 += 0.2;
              }
            }));
